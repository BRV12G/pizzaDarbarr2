...
##### stripe CLI - [webhooks for redirection after payment](https://dashboard.stripe.com/test/workbench/webhooks) REFERENCE SETUP - [STRIPE CLI SETUP](https://www.youtube.com/watch?v=LUHeCvVFATU)
